...
class RoundUnderlineTabIndicator extends Decoration {
  ...
  _UnderlinePainter createBoxPainter([VoidCallback onChanged]) {
    return _UnderlinePainter(this, onChanged, wantWidth);
  }
}

class _UnderlinePainter extends BoxPainter {
  final double wantWidth;
  _UnderlinePainter(this.decoration, VoidCallback onChanged, this.wantWidth)
...
//    );
    //希望的宽度
    double wantWidth = this.wantWidth;
    //取中间坐标
